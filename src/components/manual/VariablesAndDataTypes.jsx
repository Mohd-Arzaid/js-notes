        ...
        <Accordion type="single" collapsible className="w-full">
          ...
          Variables ?
            ...
            We store data in memory and access it using its address. But since
              ...
              called{" "}
              <span className="text-primary font-geist text-[15px] md:text-[18px] font-medium underline decoration-neutral-200 decoration-2 underline-offset-[0.27em] transition-colors hover:decoration-neutral-800 ">
                Variables
              </span>
              {/* Quick Summary */}
              <div className="mt-5 my-2 p-4 bg-neutral-100 rounded-lg shadow-input mx-1">
                ...
                <div className="font-geist text-[15px] md:text-[18px] tracking-wider text-secondary">
                  Variables = <span className="text-primary  font-geist text-[15px] md:text-[18px] font-medium underline decoration-neutral-200 decoration-2 underline-offset-[0.27em] transition-colors hover:decoration-neutral-800 ">
